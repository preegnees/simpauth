...
//
// GET /me
func (c *Client) MeGet(ctx context.Context) error {
	res, err := c.sendMeGet(ctx)
	_ = res
	return err
}

func (c *Client) sendMeGet(ctx context.Context) (res *MeGetOK, err error) {
...
func (c *Client) sendTestGet(ctx context.Context) (res TestGetRes, err error) {
	...
	if err := c.securityBearerAuth(ctx, "TestGet", r); err != nil {
